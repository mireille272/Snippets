...
const RegisterPage = ({profileImage, setProfileImage}) => {
  ...
  const handleSignup = async (event) => {
    ...
    if (data.password.length < 8 || data.password.length > 20){
      toast.error("password must be at at least 8-12 characters")
    }
        ...
        <Row className="pt-5 justify-content-center">
          ...
          >
            ...
            <Form.Group>
              ...
              <AvatarPicker profileImage={profileImage} setProfileImage={setProfileImage}/>
            </Form.Group>
            {data.errorMessage && (
